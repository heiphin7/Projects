/*
Данный файл предназначен для хранения заготовленных массивов
а также для выполнения таких действий как:
1. Красивый вывод массива ввиде реального судоку
2. Возвращение массива(Это необходимо для корректной работы других методов)
А также этот файл создан для улучщения читабельности кода, чтобы не было всё и сразу в одном файле
*/
public class presets{
    ...
    // Этот метод нужен, чтобы остальные методы работали правильно, ведь у некоторых методов на вход идёт массив
